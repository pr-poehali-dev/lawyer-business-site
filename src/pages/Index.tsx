  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "hsl(var(--cream))", color: "hsl(var(--text-primary))", fontFamily: "'IBM Plex Sans', sans-serif" }}>
      ...
      <header
        ...
        style={{ backgroundColor: "hsl(var(--navy))", borderBottom: "1px solid rgba(255,255,255,0.07)" }}
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
          <button onClick={() => scrollTo("hero")} className="flex items-center gap-3">
            <div className="w-8 h-8 flex items-center justify-center" style={{ border: "1px solid hsl(var(--gold))" }}>
              <span style={{ fontFamily: "'Cormorant Garamond', serif", color: "hsl(var(--gold))", fontSize: 14, fontWeight: 700 }}>СВ</span>
            </div>
            <span className="hidden sm:block text-white text-lg font-semibold tracking-wide" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Смирнов и Волкова
            </span>
          </button>
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {navItems.map((item) => (
              <button
                ...
                style={{ color: activeNav === item.id ? "hsl(var(--gold))" : "rgba(255,255,255,0.65)" }}
              >
                {item.label}
              </button>
            ))}
          ...
          <button
            ...
            className="hidden lg:flex items-center gap-2 px-5 py-2 text-xs font-semibold tracking-wider uppercase transition-opacity hover:opacity-85"
        ...
        {menuOpen && (
          <div style={{ backgroundColor: "hsl(var(--navy-light))", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, transparent, transparent 60px, rgba(255,255,255,1) 60px, rgba(255,255,255,1) 61px)",
          }}
        />
        <div className="absolute left-0 top-0 bottom-0 w-1" style={{ backgroundColor: "hsl(var(--gold))" }} />

        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-28 lg:py-36 w-full">
          <div className="max-w-3xl">
            <p
              className="animate-fade-in opacity-0 text-xs tracking-[0.35em] uppercase mb-6"
              style={{ color: "hsl(var(--gold))", animationFillMode: "forwards" }}
            >
              Юридическая практика · Москва
            </p>
            <h1
              className="animate-fade-in opacity-0 text-white leading-[1.05] mb-8"
              style={{
            ...
            >
              Защищаем ваши<br />
              <em style={{ color: "hsl(var(--gold))" }}>права</em> и интересы
            </h1>
            <p
              className="animate-fade-in opacity-0 text-lg leading-relaxed max-w-xl mb-12"
              style={{ color: "rgba(255,255,255,0.55)", animationDelay: "0.2s", animationFillMode: "forwards" }}
            >
            ...
            <div
              className="animate-fade-in opacity-0 flex flex-wrap gap-4"
              style={{ animationDelay: "0.3s", animationFillMode: "forwards" }}
            >
              <button
                onClick={() => scrollTo("booking")}
                className="px-8 py-4 text-sm font-semibold tracking-wider uppercase transition-opacity hover:opacity-85"
                style={{ backgroundColor: "hsl(var(--gold))", color: "hsl(var(--navy))" }}
              >
                Записаться на консультацию
              </button>
            ...
            <div
              className="animate-fade-in opacity-0 flex gap-12 mt-16 pt-10"
              style={{ borderTop: "1px solid rgba(255,255,255,0.1)", animationDelay: "0.5s", animationFillMode: "forwards" }}
            >
              {[["18+", "лет практики"], ["600+", "дел решено"], ["2", "партнёра"]].map(([num, label]) => (
                <div key={label}>
                  <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 40, fontWeight: 700, color: "hsl(var(--gold))", lineHeight: 1 }}>
                    {num}
                  </div>
      ...
      <section id="about" className="py-24 lg:py-32" style={{ backgroundColor: "hsl(var(--cream))" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="reveal mb-16">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: "hsl(var(--gold))" }}>О специалистах</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            {lawyers.map((l, i) => (
              <div key={l.id} className={`reveal ${i === 1 ? "md:mt-12" : ""}`}>
                <div className="group overflow-hidden" style={{ backgroundColor: "white", boxShadow: "0 4px 32px rgba(0,0,0,0.07)" }}>
                  <div className="relative overflow-hidden h-80">
                    ...
                    />
                    <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(14,26,52,0.85) 0%, transparent 55%)" }} />
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      <p className="text-xs tracking-[0.25em] uppercase mb-1" style={{ color: "hsl(var(--gold))" }}>{l.specialization}</p>
                      <h3 className="text-white font-semibold text-2xl" style={{ fontFamily: "'Cormorant Garamond', serif" }}>{l.name}</h3>
                      <p className="text-sm" style={{ color: "rgba(255,255,255,0.65)" }}>{l.title}</p>
                    </div>
                  </div>
                  <div className="p-6 lg:p-8">
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-6" style={{ borderTop: "1px solid hsl(var(--cream-dark))" }}>
                      <div>
                        <p className="text-xs tracking-wider uppercase mb-1" style={{ color: "hsl(var(--gold))" }}>Опыт</p>
                        <p className="text-sm font-medium" style={{ color: "hsl(var(--navy))" }}>{l.experience}</p>
                      </div>
                      <div>
                        <p className="text-xs tracking-wider uppercase mb-1" style={{ color: "hsl(var(--gold))" }}>Дел закрыто</p>
                        <p className="text-sm font-medium" style={{ color: "hsl(var(--navy))" }}>{l.cases}+</p>
                      </div>
                      <div className="col-span-2">
                        <p className="text-xs tracking-wider uppercase mb-1" style={{ color: "hsl(var(--gold))" }}>Образование</p>
      ...
      <section id="services" className="py-24 lg:py-32" style={{ backgroundColor: "hsl(var(--navy))" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="reveal mb-16">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: "hsl(var(--gold))" }}>Практика</p>
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem,5vw,4rem)", color: "white", lineHeight: 1.1 }}>
              Направления<br />
              <em style={{ color: "hsl(var(--gold))" }}>работы</em>
            </h2>
            <div className="w-14 h-0.5 mt-4" style={{ backgroundColor: "hsl(var(--gold))" }} />
          </div>

          <div
            className="grid sm:grid-cols-2 lg:grid-cols-3"
            style={{ border: "1px solid rgba(255,255,255,0.08)", borderRight: "none", borderBottom: "none" }}
          >
            {services.map((s) => (
              <div
                key={s.title}
                className="reveal group p-8 lg:p-10 transition-colors duration-300 cursor-default"
                style={{
              ...
              >
                <div className="w-10 h-10 flex items-center justify-center mb-6" style={{ border: "1px solid rgba(255,255,255,0.15)" }}>
                  <Icon name={s.icon as "Scale"} size={16} style={{ color: "rgba(255,255,255,0.5)" }} />
                </div>
                <h3
                  className="text-white text-xl mb-3 transition-colors duration-200"
      ...
      <section id="cases" className="py-24 lg:py-32" style={{ backgroundColor: "hsl(var(--cream))" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="reveal mb-16">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: "hsl(var(--gold))" }}>Результаты</p>
            <h2 className="gold-line" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem,5vw,4rem)", color: "hsl(var(--navy))" }}>
              Избранные дела
            </h2>
          </div>
          ...
          <div style={{ borderTop: "1px solid hsl(var(--cream-dark))" }}>
            {cases.map((c, i) => (
              <div
                key={i}
                className="reveal flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 py-6 -mx-4 px-4 transition-colors duration-200"
      ...
      <section id="prices" className="py-24 lg:py-32" style={{ backgroundColor: "hsl(var(--navy-light))" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="reveal mb-16">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: "hsl(var(--gold))" }}>Стоимость</p>
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem,5vw,4rem)", color: "white", lineHeight: 1.1 }}>
              Прозрачные<br />
              <em style={{ color: "hsl(var(--gold))" }}>цены</em>
            </h2>
            <div className="w-14 h-0.5 mt-4" style={{ backgroundColor: "hsl(var(--gold))" }} />
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {prices.map((p, i) => (
              <div
                key={p.title}
                className="reveal p-8 transition-transform duration-200 hover:-translate-y-1"
                style={{
              ...
              >
                ...
                <p className="text-2xl mb-3" style={{ fontFamily: "'Cormorant Garamond', serif", color: "hsl(var(--gold))" }}>{p.price}</p>
          ...
          <div
            className="reveal mt-8 p-6 flex items-start gap-4"
            style={{ backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.09)" }}
          >
            <Icon name="Info" size={17} className="flex-shrink-0 mt-0.5" style={{ color: "hsl(var(--gold))" }} />
      ...
      <section id="booking" className="py-24 lg:py-32" style={{ backgroundColor: "hsl(var(--cream))" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="reveal mb-12">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: "hsl(var(--gold))" }}>Запись</p>
            <h2 className="gold-line" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem,5vw,4rem)", color: "hsl(var(--navy))" }}>
          ...
          {bookingDone ? (
            <div
              className="reveal max-w-lg p-12 text-center"
              style={{ backgroundColor: "white", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}
            >
              <div
                className="w-16 h-16 flex items-center justify-center mx-auto mb-6"
                style={{ backgroundColor: "hsl(var(--cream))", border: "2px solid hsl(var(--gold))" }}
              >
                <Icon name="Check" size={26} style={{ color: "hsl(var(--gold))" }} />
              </div>
              <h3 className="text-2xl mb-3" style={{ fontFamily: "'Cormorant Garamond', serif", color: "hsl(var(--navy))" }}>
                Запись принята
              </h3>
            ...
            <form onSubmit={handleBooking} className="reveal max-w-3xl">
              <div className="grid gap-7">
                {/* Lawyer */}
                <div>
                  <label className="text-xs tracking-widest uppercase block mb-3" style={{ color: "hsl(var(--text-secondary))" }}>
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {lawyers.map((l) => (
                      <button
                        type="button"
                        key={l.id}
                        onClick={() => setBooking({ ...booking, lawyer: l.name })}
                        className="p-4 text-left flex items-center gap-4 transition-all duration-150"
                        style={{
                          border: `2px solid ${booking.lawyer === l.name ? "hsl(var(--gold))" : "hsl(var(--cream-dark))"}`,
                          backgroundColor: booking.lawyer === l.name ? "rgba(197,155,64,0.07)" : "white",
                        }}
                      >
                    ...
                    {dates.slice(0, 10).map((d, i) => {
                      ...
                      return (
                        <button
                          type="button"
                          key={i}
                          onClick={() => setBooking({ ...booking, date: formatted })}
                          className="px-3 py-2 text-xs transition-all duration-150"
                          style={{
                            border: `1px solid ${active ? "hsl(var(--gold))" : "hsl(var(--cream-dark))"}`,
                            backgroundColor: active ? "hsl(var(--gold))" : "white",
                            color: active ? "hsl(var(--navy))" : "hsl(var(--text-primary))",
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={f.key}>
                      <label className="text-xs tracking-widest uppercase block mb-2" style={{ color: "hsl(var(--text-secondary))" }}>
                        {f.label}
                      </label>
                      <input
                        type={f.type}
                ...
                <div>
                  <button
                    type="submit"
                    className="px-10 py-4 text-sm font-semibold tracking-wider uppercase transition-opacity hover:opacity-85"
                    style={{ backgroundColor: "hsl(var(--navy))", color: "hsl(var(--gold))" }}
                  >
                    Подтвердить запись
                  </button>
                </div>
      ...
      <section id="faq" className="py-24 lg:py-32" style={{ backgroundColor: "white" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="reveal mb-16">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: "hsl(var(--gold))" }}>Вопросы</p>
            <h2 className="gold-line" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem,5vw,4rem)", color: "hsl(var(--navy))" }}>
              Часто задают
            </h2>
          </div>
            ...
            {faqs.map((f, i) => (
              ...
              >
                ...
                >
                  ...
                  <Icon name={activeFaq === i ? "Minus" : "Plus"} size={17} className="flex-shrink-0 mt-0.5" style={{ color: "hsl(var(--gold))" }} />
                </button>
                {activeFaq === i && (
                  <p className="text-sm leading-relaxed mt-4 animate-fade-in" style={{ color: "hsl(var(--text-secondary))" }}>
                    {f.a}
                  </p>
                )}
              </div>
      ...
      <section id="contacts" className="py-24 lg:py-32" style={{ backgroundColor: "hsl(var(--navy))" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="reveal mb-16">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: "hsl(var(--gold))" }}>Контакты</p>
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem,5vw,4rem)", color: "white", lineHeight: 1.1 }}>
              Свяжитесь<br />
              <em style={{ color: "hsl(var(--gold))" }}>с нами</em>
            </h2>
            <div className="w-14 h-0.5 mt-4" style={{ backgroundColor: "hsl(var(--gold))" }} />
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 lg:gap-24">
            ...
            <div className="reveal space-y-8">
              {[
                ...
                { icon: "Mail", label: "Email", value: "info@smirnov-volkova.ru" },
                { icon: "Clock", label: "Часы работы", value: "Пн–Пт: 09:00–19:00" },
              ].map((c) => (
                <div key={c.label} className="flex items-start gap-4">
                  <div className="w-10 h-10 flex items-center justify-center flex-shrink-0" style={{ border: "1px solid rgba(255,255,255,0.15)" }}>
                    <Icon name={c.icon as "MapPin"} size={15} style={{ color: "hsl(var(--gold))" }} />
                  </div>
                  <div>
                    <p className="text-xs tracking-widest uppercase mb-1" style={{ color: "rgba(255,255,255,0.35)" }}>{c.label}</p>
            ...
            <div className="reveal">
              {contactDone ? (
                ...
                >
                  <Icon name="CheckCircle" size={38} className="mx-auto mb-4" style={{ color: "hsl(var(--gold))" }} />
                  <h3 className="text-2xl text-white mb-2" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                    Сообщение отправлено
                  </h3>
                  <p className="text-sm" style={{ color: "rgba(255,255,255,0.45)" }}>Ответим в течение рабочего дня</p>
                </div>
              ) : (
                <form onSubmit={handleContact} className="space-y-4">
                  {[
                    ...
                    <div key={f.key}>
                      <label className="text-xs tracking-widest uppercase block mb-2" style={{ color: "rgba(255,255,255,0.35)" }}>
                        {f.label}
                      </label>
                      <input
                        type={f.type}
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 text-sm font-semibold tracking-wider uppercase transition-opacity hover:opacity-85"
                    style={{ backgroundColor: "hsl(var(--gold))", color: "hsl(var(--navy))" }}
                  >
                    Отправить сообщение
                  </button>
      ...
      <footer
        className="py-8"
        style={{ backgroundColor: "hsl(var(--navy-light))", borderTop: "1px solid rgba(255,255,255,0.06)" }}
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs" style={{ color: "rgba(255,255,255,0.28)" }}>
            © 2024 Смирнов и Волкова. Все права защищены.
          </p>
